...
$(function()
{
  var clearCacheMenu = $("#clear-cache");
  ...
  {
    clearCacheMenu.append(WebDeveloper.Locales.getString("clearCache")).on("click", WebDeveloper.Overlay.Miscellaneous.confirmClearCache);
  }
  else
  {
    clearCacheMenu.hide();
