...
document.addEventListener("installedEditorsChoice", () => {
	 chrome.runtime.sendMessage({method: "installedEditorsChoice"}); 
	}, false);
...
document.addEventListener("getStylishMetadata", function() {
    chrome.runtime.sendMessage({method: "getMetadata"}, function(response) {
        sendEvent("stylishMetadata",response);
        });
}, false);